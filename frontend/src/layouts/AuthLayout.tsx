...
export default function AuthLayout() {
  return (
    <main className="relative grid min-h-screen overflow-hidden bg-background lg:grid-cols-12">
      <section className="relative hidden border-r border-border/70 bg-[#080D15] p-10 lg:col-span-7 lg:flex lg:flex-col" aria-label="ForgeSight security context">
        ...
        <div className="relative z-10 my-auto max-w-xl">
          ...
          <h1 className="mt-5 text-balance text-4xl font-semibold leading-tight tracking-tight xl:text-5xl">
      ...
      <section className="flex min-h-screen items-center justify-center px-4 py-10 sm:px-8 lg:col-span-5">
